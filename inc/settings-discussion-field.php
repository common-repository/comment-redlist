...
$comment_redlist_fields = array(

'section' => '
	<p>' . $this->lang['settings_section_p'] . '</p>
',

'sequences' => '
	<fieldset>
		<legend class="screen-reader-text">
			<span>' . $this->lang['sequences_textarea_label'] . '</span>
		</legend>
		<p>
			<label for="comment_redlist_sequences">
				' . $this->lang['desc'] . '
			</label>
		</p>
		<p>
...
'ip_addrs' => '
	<fieldset>
		<legend class="screen-reader-text">
			<span>' . $this->lang['ip_addrs_textarea_label'] . '</span>
		</legend>
		<p>
			<label for="comment_redlist_ip_addrs">
				' . $this->lang['ip_addrs_desc'] . '
			</label>
		</p>
		<p>
